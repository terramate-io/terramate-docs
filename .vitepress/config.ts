            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Component Definition', link: '/catalyst/reference/component-definition' },
                {
                  ...
                  collapsed: true,
                  items: [
                    { text: 'tm_bundles', link: '/catalyst/reference/functions/tm_bundles' },
                    { text: 'tm_bundle', link: '/catalyst/reference/functions/tm_bundle' },
                    { text: 'tm_source', link: '/catalyst/reference/functions/tm_source' },
                  ],
                },
