...
Linking accounts can be done in the [user profile](/settings/index.md).
Learn more about this in the [account linking](/settings/account-linking.md) documentation.
:::
...
![Alerts in Terramate Cloud](../cloud/assets/alerts/alert-list.png)
...
![Slack alert notification](../cloud/assets/alerts/alert-details.png)
...
![Slack alert notification](../cloud/assets/alerts/slack-notification.png)
...
- [Cloud API: Alerts](/reference/cloud-api/alerts)
