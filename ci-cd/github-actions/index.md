...
Terramate Cloud user. Learn to link your accounts in the [account linking](/settings/account-linking.md) documentation.
:::
...
It's recommended to install the [Terramate App for GitHub](/integrations/github/index.md) in your GitHub organization
...
for details please see the [integration with GitHub](/integrations/github/index.md) documentation.
...
For that, you must configure the [GitHub Trust](/settings/settings.md#general-settings) in the settings
