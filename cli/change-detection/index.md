...
This distinction ensures that dependency filters only widen the scope to stacks that actually need to be included due to data dependencies, not just execution order requirements.
:::
