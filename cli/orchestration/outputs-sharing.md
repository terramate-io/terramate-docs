...
- `sensitive` _(optional, boolean)_ - Marks the value as sensitive.
...
::: info
Since `v0.10.9` the `sensitive` field has no default value and is only generated when set in the config.
:::
