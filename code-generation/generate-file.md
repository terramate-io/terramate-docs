...
[Variables](/cli/reference/variables/index.md) and [Metadata](/cli/reference/variables/metadata.md).
...
Terramate Variables (`let`, `global`, and `terramate` namespaces) and all [Terramate Functions](/cli/reference/functions/index.md)
...
- `content` *(required string)* The `content` argument defines the string that will be generated as the content of the file.
  ...
  - [Terramate function](/cli/reference/functions/index.md) calls `tm_*(...)`
...
- `lets` *(optional block)* One or more `lets` blocks can be used to define [temporary variables](/cli/reference/variables/lets.md)
