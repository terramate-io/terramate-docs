...
You can use Terramate data such as [globals](https://terramate.io/docs/code-generation/variables/globals) , [metadata](https://terramate.io/docs/code-generation/variables/metadata) or [functions](https://terramate.io/docs/code-generation/functions/) in a `.tmgen` file.
...
terramate {
  config {
    ...
    # https://terramate.io/docs/code-generation/tmgen
    experiments = [
      "tmgen"
    ]
  }
