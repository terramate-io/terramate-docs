---
title: Set Up Terramate Cloud
description: Learn how to connect Terramate CLI with Terramate Cloud and start synchronizing data for drift detection, deployments, and pull request previews.
---

# Set Up Terramate Cloud

After installing Terramate CLI, setting up your repository, and importing any existing configuration you can start using Terramate Cloud. The onboarding should not take long but includes the time it needs to run your first drift check over all your stacks and requires some configuration of automation pipelines -- we have you covered with existing Terramate Automation Blueprints for the most common CI/CD platforms.
...
When the login is successful a message to continue in the CLI is shown in the browser and the CLI will also confirm the success.
...
After running the initial drift run, Slack notifications should be enabled to get notified about newly detected drifts.
...
- [GitHub Actions Blueprints](/ci-cd/github-actions/drift-check-workflow)
- [GitLab CI Blueprints](/ci-cd/gitlab-ci/drift-check-workflow)
- [Bitbucket Pipelines Blueprints](/ci-cd/bitbucket-pipelines/drift-check-workflow)
...
- [GitHub Actions Blueprints](/ci-cd/github-actions/deployment-workflow)
- [GitLab CI Blueprints](/ci-cd/gitlab-ci/deployment-workflow)
- [Bitbucket Pipelines Blueprints](/ci-cd/bitbucket-pipelines/deployment-workflow)
...
- [GitHub Actions Blueprints](/ci-cd/github-actions/preview-workflow)
- [GitLab CI Blueprints](/ci-cd/gitlab-ci/preview-workflow)
- [Bitbucket Pipelines Blueprints](/ci-cd/bitbucket-pipelines/preview-workflow)
