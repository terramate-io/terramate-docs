...
- Attributes and Blocks Reference of the `script` block
  ...
  - [`lets`](/cli/reference/variables/lets.md) _(optional)_ - One or more blocks containing local variable definitions for the script.
...
- `sync_deployment` _(optional boolean)_ Send information about the deployment to Terramate Cloud. See [Sending deployment data to Terramate Cloud](/cli/reference/cmdline/run.md#sending-deployment-data-to-terramate-cloud). Only one command per script may have this option set to true.
- `sync_preview` _(optional boolean)_ Send information about a _Pull Request_ preview to Terramate Cloud. See [Sending a Pull Request Preview to Terramate Cloud](/cli/reference/cmdline/run.md#sending-a-pull-request-preview-to-terramate-cloud). Only one command per script may have this option set to true.
- `sync_drift_status` _(optional boolean)_ Send drift information to Terramate Cloud. See [Detecting Drifts](/cli/reference/cmdline/run.md#detecting-drift).
...
<img src="../cli/assets/orchestration/scripts-scope.svg" width="600px" alt="Shows an example by highlighting the scope of a script named" />
...
<img src="../cli/assets/orchestration/scripts-visibility.svg" width="600px" alt="Explaining the visibility of a script in Terramate" />
...
- [`terramate script list`](/cli/reference/cmdline/script/script-list.md)
...
- [`terramate script info <scriptname>`](/cli/reference/cmdline/script/script-info.md)
...
- [`terramate script tree`](/cli/reference/cmdline/script/script-tree.md)
