...
![Policy Checks in Terramate Cloud](../cloud/assets/policy-check.png)

Policies are tightly integrated with the [Resource Browser](/dashboard/index.md) in Terramate Cloud. This integration provides you with a comprehensive view of:
