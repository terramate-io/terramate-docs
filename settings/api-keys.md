...
![Create Api Key](../cloud/assets/api-key/create-api-key1.png)

3. Provide a name or label for the key to identify its purpose.

![Api Key Name](../cloud/assets/api-key/api-key-name.png)

4. Confirm the action. The API key will be generated and displayed.

![Api Key Displayed](../cloud/assets/api-key/api-key-displayed.png)

5. Save the key securely as it will not be shown again.

## Managing API Keys

![Manage Api Keys](../cloud/assets/api-key/api-keys-manage.png)
