...
With Terramate CLI you can easily clone stacks and nested stacks using the [clone](/cli/reference/cmdline/experimental/experimental-clone.md) command.

Imagine you develop a new service in staging that you want to roll out to production. Instead of manually copying and
pasting a bunch of stacks, updating stack properties such as `stack.id`, etc., [clone](/cli/reference/cmdline/experimental/experimental-clone.md) does this
...
For details please see the [clone command](/cli/reference/cmdline/experimental/experimental-clone.md) documentation.
