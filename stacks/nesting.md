...
- **The configuration is inherited from left to right:** a [Global Variable](/cli/reference/variables/globals.md)
...
- **Cloning of stacks:** nested stacks can represent whole environments, services or single resources. A neat feature in
  ...
  [clone](/cli/reference/cmdline/experimental/experimental-clone.md) command.
...
For details please see the [run](/cli/reference/cmdline/run) command documentation.
:::
...
This pattern allows us to use the [Terramate Change Detection](../orchestration/change-detection/index.md). For example, if we were
