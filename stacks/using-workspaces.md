---
title: Using Terraform CLI Workspaces
...
2. Create a new project, add a couple of stacks, and sync to Terramate Cloud by following the quickstart guide up to this [step](/cli/getting-started/#login-from-cli).
